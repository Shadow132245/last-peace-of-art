  ...
  return (
    <>
      <section className="relative overflow-hidden px-4 pb-20 pt-20 sm:pb-32 sm:pt-32">
        ...
        <div className="absolute -top-40 left-1/2 h-80 w-80 -translate-x-1/2 rounded-full bg-amber-100/30 blur-3xl dark:bg-transparent" />
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="relative mx-auto mt-6 max-w-2xl text-lg text-zinc-500 dark:text-zinc-400">
          ...
          <div className="relative mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              href="/register"
              className="rounded-lg bg-zinc-900 px-8 py-3 text-sm font-medium text-white shadow-lg shadow-zinc-900/20 transition-all hover:scale-105 hover:bg-zinc-800 dark:bg-white dark:text-zinc-900 dark:shadow-none dark:hover:bg-zinc-100"
            >
              Get Started Free
            </Link>
            <Link
              href="/projects"
              className="rounded-lg border border-zinc-300 bg-white/50 px-8 py-3 text-sm font-medium text-zinc-700 shadow-sm backdrop-blur transition-all hover:scale-105 hover:bg-white dark:border-zinc-600 dark:bg-transparent dark:text-zinc-300 dark:shadow-none dark:hover:bg-zinc-800/30"
            >
              Browse Projects
            </Link>
          </div>
...
function FeatureCard({ icon, title, desc, index }: { icon: string; title: string; desc: string; index: number }) {
  return (
    <div
      className="group rounded-xl border border-zinc-200 bg-white p-6 shadow-sm transition-all hover:border-amber-200 hover:shadow-md dark:border-zinc-800 dark:bg-transparent dark:hover:border-zinc-600 dark:hover:shadow-none"
