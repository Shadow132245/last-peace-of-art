...
- ⚠️ Did NOT fix the issue — user still had to refresh

### Session 58d — 2026-06-19 (Force locale remount via tick counter)
- Completely removed `LocaleAnimation` and `motion.div` wrapper
